  ...
  <div class="mainpage">
    ...
    <div class="main-box self-box">
      <div class="left-menu">
        ...
        <div class="menu-item choose" v-on:click="gotoSelfPage()">
          个人信息
          <span></span>
        </div>
      </div>
...
export default {
  ...
  methods: {
    add_img(event) {
      ...
      let url = buildUrl("/index/center/upload");

      form.append("file[0]", img1, img1.name);
      axios
        .post(url, form, {
          headers: {
        ...
        .then(response => {
          ...
          url = buildUrl("/index/center/profile");
          axios
            .post(
              url,
              {
      ...
      axios
        ...
        .then(response => {
          ...
          if (response.data.code == "600000") {
            ...
            this.imgurl = info.profile;
            let image = buildUrl(info.profile);
            this.headimg = image;
    ...
    LoginFn: function() {
      ...
      let url = buildUrl("/index/center/userinfo");
      axios
        .post(
          url,
          {
